...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;400&family=Roboto&display=swap"
        rel="stylesheet">
...
<body>
    ...
    <nav>
        <p><img src="./assets/projet_cyprien_bitarelle.jpg"
                alt="Photo de présentation de Cyprien Bitarelle de dos en train de travailler sur un projet."></p>
        <ul>
            <a href="#accueil">
                <li>Accueil</li>
            </a>
                ...
                <div class="right bottom">
                    ...
                    <ul>
                        ...
                        <li class="soft-skills"><img src="./assets/relation.png" alt="icone relation client"> Relation
                            client</li>
                        <li class="soft-skills"><img src="./assets/decision.png"
                                alt="icone esprit critique et prise de décision"> Esprit
        ...
        <section id="projets">
            ...
            <div id="liste_projets">
                <a href="./projet_meteo/meteo.html" target="_blank">
                    <div class="card">
                        <p class="images-projets"><img src="./assets/projet-meteo.png"
                                alt="Image de mon projet météo réalisé en utilisant l'API OpenWeatherMap"></p>
                        <div class="content">
                ...
                <a href="./projet_morpion/morpion.html" target="_blank">
                    <div class="card">
                        <p class="images-projets"><img src="./assets/projet-morpion.png"
                                alt="Image de mon projet morpion, réalisé en Javascript">
                        </p>
                        <div class="content">
